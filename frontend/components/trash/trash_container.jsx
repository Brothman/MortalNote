...
import Note from './trash_note.jsx';
import { fetchNotebooksAndNotes, receiveNotebooksAndNotes } from '../../actions/notebook_actions.js';
import { clearNote, receiveUpdatedNote, fetchDeletedNotes } from '../../actions/note_actions.js';
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        fetchDeletedNotes: () => dispatch(fetchDeletedNotes()),
    };
};
