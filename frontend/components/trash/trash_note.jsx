...
import { updateNote, deleteNote, restoreNote } from '../../actions/note_actions.js';
    ...
    render() {
        ...
        return (
            <div className="note">
                ...
                <i className="note-trash-open-icon fas fa-redo-alt"
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        restoreNote: (noteID, notebookID) => dispatch(restoreNote(noteID, notebookID))
    };
};
